package com.example.i325639.myapplication.recyclerview;
...
public class RecyclerViewActivity extends AppCompatActivity implements RecyclerItemTouchHelper.RecyclerItemTouchHelperListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        coordinatorLayout = (CoordinatorLayout)findViewById(R.id.movie_layout);

        mAdapter = new MoviesAdapter(this, movieList);
        RecyclerView.LayoutManager mLayoutManager = new GridLayoutManager(this, 2);//new LinearLayoutManager(getApplicationContext());
