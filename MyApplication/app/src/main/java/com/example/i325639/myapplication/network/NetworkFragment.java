        ...
        private String downloadUrl(URL url) throws IOException {
            ...
            try {
                ...
                if(redirect){
                    ...
                    connection2.addRequestProperty("Accept-Language", "en-US,en;q=0.8");
                    connection2.addRequestProperty("User-Agent", "Mozilla");
                    connection2.addRequestProperty("Referer", "google.com");
